...
```
The random forest model (`r rf_accuracy`) and stacked model (`r comb_accuracy`) show similar accuracy. Therefore, I selected the random forest model to apply to the validation data.
